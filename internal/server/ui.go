...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> BANDOLIER</h1>
...
<script>
var A='/api';
var RESOURCE='env_vars';
var TITLE_FIELD='key';

var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "key", "label": "Key", "type": "text"}, {"name": "value", "label": "Value", "type": "text"}, {"name": "environment", "label": "Environment", "type": "text"}, {"name": "project", "label": "Project", "type": "text"}, {"name": "sensitive", "label": "Sensitive", "type": "integer"}, {"name": "description", "label": "Description", "type": "textarea"}, {"name": "created_at", "label": "Created At", "type": "text"}];
